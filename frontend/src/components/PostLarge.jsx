...
const PostLarge = ({postData}) => {
  ...
  return (
    <div className='border border-gray-400 shadow-lg w-2/3 h-full flex flex-col items-start justify-around py-4 px-4 rounded-lg'>
      ...
      <p className="min-h-20 flex-grow">{body}</p>
